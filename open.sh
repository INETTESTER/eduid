...
##########################################################################
                     API="Login_CID" 
                     google_sheet="https://docs.google.com/spreadsheets/d/1Z93ZJv4TqTvpRfMFEw_hQRpBi-pmj6Z0PStQRmxEUME/edit?gid=1610289956#gid=1610289956" 
                     id="9999"                 #เปลี่ยน id ทุกครั้งที่ยิง
                     user="1";            #จำนวนผู้ใช้งาน
                     duration="1";         #วินาที
                     scenario="1"           #scenario="1" ยิงเเบบกำหนด request (duration ได้แค่ 1 วินาที)
                     cid="5628899"                #scenario="2" ยิงเเบบกำหนด VUs  (กำหนดว่า user x คน ใช้ระบบ x วินาที)
